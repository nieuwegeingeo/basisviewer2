...
Geogem.PdokLocatieServer = OpenLayers.Class(OpenLayers.Control, {
    ...
    url: window.location.protocol+'//geodata.nationaalgeoregister.nl/locatieserver/v3/suggest?q=type:adres%20and%20nieuwegein%20and%20',
        ...
        $('input', this.div).autocomplete(
		{
            ...
            select: function(event, ui) {
                ...
                if (ui.item) {
                    ...
                    var request = OpenLayers.Request.GET({
						url: window.location.protocol+'//geodata.nationaalgeoregister.nl/locatieserver/v3/lookup',
